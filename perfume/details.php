...
if (isset($_GET['id'])) {
  ...
  $get_pro_d = "select * from product_perfume where id_p_p = '$id_p_p'";
...
<div class="panle box-shadow w-p-details">
     ...
     <div class="panle_title"><?php echo $row_pro_d['title_p_p']; ?></div>

     <img src="<?php echo 'admin/img/'.$row_pro_d['img_p_p'].''; ?>" width="100%" style="padding: 10px;" />
...
<div class="panle box-shadow w-p-details">
      ...
      <div class="panle_body">
          <div id="p_info"><b>Customer Reviews : </b> 
            <span class="fa fa-star cheked"></span> <?php echo $row_pro_d['stars_p_p']; ?>/5
         </div> 
         <div id="p_info"><b>Price : <?php echo $row_pro_d['price_p_p']; ?> DH</b>  <s><?php echo $row_pro_d['price_p_p_c'];?> DH</s></div>
         <div id="p_info"><b>Category :</b> 
            <?php  
               $cat = $row_pro_d['cat_p_p'];

               $get_cat = "select * from cat_perfume where id_cat_perfume = '$cat'";

               $run_cat = mysqli_query($connect , $get_cat);

               $row_cat = mysqli_fetch_array($run_cat);

               echo $row_cat['name_cat_perfume'];
          ?>
         </div>   
         <div id="p_info"><b>Descrption : </b><br>
               <?php echo $row_pro_d['desc_p_p']; ?>
         </div>
